...
@section('meta')
   ...
   <!-- Meta Item -->
   <title>{{ $meta['meta'][$lang]['title'] ?? 'ig.digimar.id – Bangun Branding Kuat Lewat Instagram' }}</title>
    <meta name="description" content="{{ $meta['meta'][$lang]['description'] ?? 'Kelola reels, story, dan konten visual lainnya untuk memperkuat interaksi dan meningkatkan penjualan dengan Digimar.' }}">
    <meta name="keywords" content="{{ $meta['meta'][$lang]['keywords'] ?? 'instagram marketing, strategi instagram, konten visual, story, reels, interaksi audiens, branding instagram, digimar instagram' }}">
   <!-- Schema Item -->
    {{-- Schema Item --}}
