...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <meta property="og:title" content="ig.digimar.id - Maksimalkan Bisnismu Lewat TikTok Marketing">
      ...
      <meta name="twitter:title" content="ig.digimar.id - Maksimalkan Bisnismu Lewat TikTok Marketing">
