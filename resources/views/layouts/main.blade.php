...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
   <head>
      ...
      <meta property="og:title" content="ig.digimar.id - Build Strong Branding Through Instagram">
      ...
      <meta name="twitter:title" content="ig.digimar.id - Build Strong Branding Through Instagram">
